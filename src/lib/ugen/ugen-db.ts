// Registers all built-in SuperCollider UGens from JSON metadata.
// JSON files in src/assets/ugens/ are generated by: node scripts/generate_ugen_db.mjs
// Do not edit the JSON files manually.
...
[
    basicops, beq_suite, buf_io, chaos, compander, delay, demand, envgen,
    ff_osc, fft, fft2, filter, grain, info, input, io, line,
    machine_listening, misc, noise, osc, pan, random, trig,
].forEach(m => registerAll(m as JsonUGen[]));
