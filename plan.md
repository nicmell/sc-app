...
**No phase is currently in flight.** Phases 0–21 shipped. Pending
work is captured below.
...
practical session length at ~15 minutes stereo before RAM
pressure.
...
- A "Reconnect" button at the dashboard header retries the
  connect handshake and resyncs state.
